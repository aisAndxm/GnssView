...
{    
    ...
    public class myTimer
    {
        ...
        public myTimer(uint delay, uint period, byte cpuIndex, OnTickHandle tick)
        {
            Tick = tick;
            _Delay = delay;
            _Period = period;
    ...
    //void fun(object sender, long JumpPeriod, long interval) 
    //{
    //    _waitHandleCmd.Set();//启动线程
    //}


    //mMyTimer = new myTimer(100, 1000000, 1, fun);
    //mMyTimer.Open();
